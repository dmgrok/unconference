...
<template>
  ...
  <div v-if="!currentEventId" class="d-flex justify-center align-center" style="min-height: 60vh;">
    <v-card max-width="600" class="text-center pa-8">
      <v-icon size="64" color="grey-lighten-1" class="mb-4">mdi-calendar-alert</v-icon>
      <h2 class="text-h4 mb-4">No Event Selected</h2>
      <p class="text-body-1 text-medium-emphasis mb-6">
        Please select an event to access your dashboard and participate in discussions.
      </p>
      <v-btn
        color="primary"
        size="large"
